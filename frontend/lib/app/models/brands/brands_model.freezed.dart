...
class _$BrandModelImpl implements _BrandModel {
  ...
  @override
  String toString() {
    return 'BrandModel(id: $id, name: $name, featured: $featured, photo: $photo)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, featured, photo);
...
abstract class _BrandModel implements BrandModel {
  const factory _BrandModel(
      ...
      @JsonKey(name: "photo") final String? photo}) = _$BrandModelImpl;
